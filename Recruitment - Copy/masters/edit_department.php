...
<form role="form" name="" action="recruitment/masters/update_department.php" method="post" enctype="multipart/type">
...
<input type="text" class="form-control" id="name" name="name" value="<?php echo  $row['dept_name'];?>"readonly>
</td>
</tr>
<tr>
<td>Status</td>
