...
<table class="table table-bordered">
	...
	<tr>
		...
		<?php $sql=$con->query("SELECT * FROM `emp_qualification` where emp_id='$id'"); 
		...
		<tr>
		 ...
		 <td><iframe src="https://docs.google.com/viewer?url=https://Recruitment/applicationform/<?php echo $id; ?>/<?php echo $rows['attachment']; ?>">a</iframe></td>
		  	 </tr>
...
<script>
	function back_ctc()
	{
		$.ajax({
		type:"POST",
		url:"../Recruitment/Recruitment/Recruitment/Recruitment/admin_view.php",
