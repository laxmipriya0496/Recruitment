...
<table class="table table-bordered">
	...
	<?php } ?>
	<tr>
	<td colspan="6"><button class="btn btn-primary btn-sm" data-id="<?php echo $id; ?>" onclick="mail_Send(<?php echo $id; ?>)"> <i class="fa fa-mail">Appointment Letter Send</i></button></td>
	</tr>
</table>
</div>
</div>
...
function mail_Send(id)
{
	$.ajax({
	type:"POST",
	url:"Recruitment/applicationform/mail_send.php?id="+id,
	success:function(data)
	{
		if(data==0)
		{
