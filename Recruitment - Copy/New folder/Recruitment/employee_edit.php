...
$edmt = $con->prepare("SELECT position,candidate_name, father_name, dob, address, paddress, phone, mail, adharnumber, adharcard, pannumber, pancard, voternumber, votercard, resume, created_by, created_on, modified_by, modified_on FROM ctc_approval_table WHERE id='$id'"); 
$edmt->execute(); 
$row = $stmt->fetch();
