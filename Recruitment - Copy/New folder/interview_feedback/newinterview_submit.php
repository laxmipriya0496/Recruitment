...
$technical_department=$_REQUEST['technical_department'];
//$created_by = 2;
...
if($_REQUEST['replacements']=='new'){
    ...
    values('$candidatename','$position','$tech_department','$replacement','$replaced_name','$site','$Reason_leave','$reference','$tot_year_exp','$current_ctc','$exp_ctc','$notice_period','$date_of_join','$recruiter_name','$ratings','$remarks','$status_recruiter','$technical_department')");  
}
...
$sql1=$con->query("insert into recruiter_commands(candidate_id,skill_question,rating,response) values('$candidatename','$que','$performance','$answer')");
}  
