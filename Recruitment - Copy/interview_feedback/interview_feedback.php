...
<form method="POST" action="recruitment/interview_feedback/newinterview_submit.php">
...
{ alert(name);
	$.ajax({
		type:'GET',
		data:"name="+name ,
		url:'/reruitment/recruitment/interview_feedback/candidate_replace.php',
...
<td>Response:</td>
<td colspan="1">
<input type="text" class="form-control" id="technicalanswer_1" name="technical_answer[]">
</td>
