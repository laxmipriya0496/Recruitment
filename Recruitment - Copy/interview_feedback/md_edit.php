...
<td>Rating:</td>
<td colspan="5"><input type="text" class="form-control"  value="<?php echo  $rows2['rating']; ?>" readonly></td>
...
<tr>
<td>Remarks *:</td>
<td colspan="5"><input type="text" class="form-control" id="remarks_md" name="remarks_md" value="<?php echo  $rows31['md_commands']; ?>" ></td>
</tr>	<?php } ?>
<tr>	  
<td>Status*:</td>
<td colspan="5">
...
<tr>
	<td colspan="6">
		<input type="button" class="btn btn-primary btn-md"  style="float:right;" name="Update" onclick="md_update()" value="Update"> 
	</td>
</tr>
</TABLE>
</form>
...
<script>
 ...
 function md_update()
    ...
    var id=$('#get_id').val();
    var md_recruiter=$('#md_recruiter').val();
	alert(id);
    ...
    url:'Recruitment/interview_feedback/md_update1.php',
    success:function(data)
    {
      if(data==1)
      { 
