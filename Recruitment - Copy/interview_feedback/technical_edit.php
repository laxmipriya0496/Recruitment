...

{
		...
		?>
	  <tr>
	  <input type="hidden" class="form-control" id="get_id1" name="get_id" value="<?php echo $rows1['candidate_id']; ?>">
...
<td>Response:</td>
<td colspan="1"><input type="text" class="form-control" id="technical_answer1" name="technical_answer[]" value="<?php echo  $rows2['response']; ?>" ></td>
...
//alert(candidate_id);
    ...
    url:'Recruitment/interview_feedback/technical_update.php',
    success:function(data)
    {
      if(data==1)
      { 
