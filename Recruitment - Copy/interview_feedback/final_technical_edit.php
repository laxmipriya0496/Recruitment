...
<td>Response:</td><td colspan="1"><input type="text" class="form-control" id="technical_answer1" name="technical_answer1[]" value="<?php echo  $rows2['response']; ?>" readonly></td>
...
?>
 <tr>
	  <input type="hidden" class="form-control" id="get_id" name="get_id" value="<?php echo  $rows3['candidate_id']; ?>">
	 
<td>Technical Person Name:</td>
<td colspan="5"><input type="text" class="form-control" id="head_name" name="head_name" value="<?php echo  $rows3['head_name']; ?>" readonly></td>
</tr>
...
<td>Response:</td><td colspan="1"><input type="text" class="form-control" id="technical_answer" name="technical_answer[]" value="<?php echo  $rows2['response']; ?>" ></td>
...
<script>
 ...
 function feedback_update1()
    ...
    url:'Recruitment/interview_feedback/final_technical_update.php',
    success:function(data)
    {
      if(data==1)
      { 
