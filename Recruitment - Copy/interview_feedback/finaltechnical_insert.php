...
<form method="POST" action="recruitment/interview_feedback/finalfeedback_submit.php">
...
<td>Status *:</td>
<td colspan="5">
<select class="form-control" id="status_recruiter" name="status_recruiters" readonly>
<!?php
...
?>
<option value="">Selected For third level</option>
<!?php 
...
<td>Response:</td>
<td colspan="1">
<input type="text" class="form-control" id="technicalanswer_1" name="technical_answer[]" onchange="change_replace()">
</td>
