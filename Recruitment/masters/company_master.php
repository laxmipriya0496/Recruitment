    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
		  ...
		  <a onclick=" add_company()" style="float: right;" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> ADD</a>
...
<script>
    ...
    $.ajax({
    type:"POST",
    url:"/Recruitment/Recruitment/masters/new_company.php",
  ...
  function company_edit(v)
    ...
    $.ajax({
    type:"POST",
    url:"/Recruitment/Recruitment/masters/edit_company.php?id="+v,
    success:function(data){
    $(".content").html(data);
    }
    })
