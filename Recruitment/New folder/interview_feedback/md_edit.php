...
$sql=$con->query("SELECT * FROM  md_details where candidate_id='$id'");
...
<tr>
<td>Remarks *:</td>
<td colspan="5"><input type="text" class="form-control" id="md_remarks" name="md_remarks" value="<?php echo  $rows3['md_remarks']; ?>" readonly></td>
</tr>	
<tr>
<td>Status *:</td>
<td colspan="5">
<select class="form-control" id="status_recruiter" name="status_recruiter" readonly>
<?php
if($rows3['status_recruiter'] == 7){
	?>
	
<option value="">Select for Next Level</option>
<?php
}
else if($rows3['status_recruiter'] == 8){
	?>
	<option value="">Waiting List</option>
	<?php
} else {
