...
<tbody>
<?php
$emp_sql=$con->query("SELECT md.candidate_id,cfd.first_name,cfd.position,zdm.dept_name FROM `md_commands` md join candidate_form_details cfd on md.candidate_id=cfd.id join z_department_master zdm on zdm.id=cfd.department where md.status=7");
$i=1;
