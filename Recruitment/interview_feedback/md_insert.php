...
<form role="form" action="recruitment/interview_feedback/md_submit.php" method="post" enctype="multipart/type">
...
$sqll=$con->query("SELECT * FROM final_technical_team_details where candidate_id='$id'");
...

{
		...
		?>
	  <tr>
	  <input type="hidden" class="form-control" id="get_id" name="get_id<?php echo $k;?>" value="<?php echo  $rows11['candidate_id']; ?>">
<td>Technical Person Name:</td>
<td colspan="5"><input type="text" class="form-control" id="head_name" name="head_name" value="<?php echo  $rows11['head_name']; ?>" readonly></td>
</tr>
<?php
}
?>
...
<tr>
<td>Remarks *:</td>
<td colspan="5"><input type="text" class="form-control" id="remarks_md" name="remarks_md"></td>
</tr>	
<tr>
<td>Status *:</td>
<td colspan="5">
<select class="form-control" id="md_recruiter" name="status_recruiters" onchange="change_replace()">
<option value="">CHOOSE TYPE</option>
<option value="7" >Select for Next Level</option>
<option value="8">Waiting</option>
<option value="9">Rejected</option></select></td>
</tr>
</table>
